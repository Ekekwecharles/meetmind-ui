...
export default function CTABanner() {
  return (
    ...
    >
      ...
      <div className="w-full lg:max-w-272 bg-[#036475] rounded-2xl p-6 md:p-12 flex flex-col gap-8 mx-auto items-start text-left md:items-center">
        {/* Text Container*/}
        ...
        <div className="w-full md:max-w-136 flex flex-col md:flex-row gap-4 md:justify-center">
          <Link
            href="/signup"
            className="w-full md:w-auto md:min-w-66.5 text-center py-3 bg-[#036475] hover:bg-[#F7F9FB] text-[#FEFEFF] hover:text-[#02505E] border border-[#AFB1B2] hover:border-[#02505E] text-base font
          >
            Try Demo
          </Link>
          <Link
            href="/docs" // Assuming you have a /docs route in Next.js
            className="w-full md:w-auto md:min-w-66.5 text-center py-3 bg-[#036475] hover:bg-[#F7F9FB] text-[#FEFEFF] hover:text-[#02505E] border border-[#AFB1B2] hover:border-[#02505E] text-base font
          >
            View Docs
          </Link>
